...
打包完成后，在 `dist/` 目录下会生成：
- `费曼学习助手 Setup 0.1.1.exe` - NSIS 安装程序
- `费曼学习助手-0.1.1-win.exe` - 便携版（如果配置）
...
输出：
- `费曼学习助手-0.1.1.dmg` - DMG 安装镜像
- `费曼学习助手-0.1.1-mac.zip` - ZIP 压缩包
...
输出：
- `费曼学习助手-0.1.1.AppImage` - 通用 Linux 格式
- `费曼学习助手_0.1.1_amd64.deb` - Debian/Ubuntu 包
