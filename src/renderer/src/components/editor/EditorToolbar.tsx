        ...
        {group.map((item, itemIndex) => {
          ...
          return (
            <button
              ...
              className="flex items-center justify-center w-7 h-7 rounded transition-colors hover:bg-black/10"
    ...
    >
      ...
      >
        {viewModes.map(({ id, icon: Icon, label }) => (
          <button
            ...
            style={{
              background: editorViewMode === id ? 'var(--accent-primary)' : undefined,
              color: editorViewMode === id ? '#fff' : 'var(--text-muted)'
            }}
            title={label}
          >
            <Icon size={12} />
      ...
      <div className="flex items-center gap-1.5">
        ...
        <button
          ...
          style={{
            background: aiPanelOpen ? 'var(--accent-muted)' : undefined,
            color: aiPanelOpen ? 'var(--accent-primary)' : 'var(--text-muted)'
          }}
          title="切换 AI 面板 (Ctrl+\\)"
        >
          <PanelRight size={14} />
