  ...
  return (
    <div
      ...
      style={{
        ...
        background: 'color-mix(in srgb, var(--accent-muted), transparent 40%)',
      }}
    >
      ...
      <div className="flex items-center gap-1">
        <button
          ...
          style={{
            color: mode === 'edit' ? 'var(--accent-foreground)' : 'var(--text-muted)',
        ...
        <button
          className="w-6 h-6 rounded flex items-center justify-center transition-all duration-150"
          style={{
            color: mode === 'split' ? 'var(--accent-foreground)' : 'var(--text-muted)',
        ...
        <button
          className="w-6 h-6 rounded flex items-center justify-center transition-all duration-150"
          style={{
            color: mode === 'preview' ? 'var(--accent-foreground)' : 'var(--text-muted)',
  ...
  if (mode === 'split') {
    return (
      <div className="flex h-full">
        <div className="flex-1 overflow-hidden border-r" style={{ borderColor: 'var(--border-subtle)' }}>
      ...
      >
        ...
        {section.key === 'cues' && activeNodes.length > 0 && (
          <div
            ...
            style={{ borderColor: 'var(--border-subtle)', background: 'color-mix(in srgb, var(--accent-muted), transparent 50%)' }}
          >
