    ...
    >
      ...
      >
        <div className="flex items-center gap-2 min-w-0">
          ...
          {isVerifying && (
            <Loader2 size={10} className="animate-spin flex-shrink-0" style={{ color: 'var(--accent-primary)' }} />
          )}
        </div>
        <div className="flex items-center gap-1 flex-shrink-0">
          <button
            onClick={() => setShowHistory(!showHistory)}
            className={`p-1 rounded transition-colors ${showHistory ? 'bg-accent-muted text-accent' : 'text-muted hover:text-primary'}`}
            title="对话历史"
          >
            <History size={13} />
          </button>
              ...
              >
                <div
                  ...
                  style={{
                    ...
                    borderColor: 'var(--border-subtle)',
                    background: 'var(--cornell-header-bg)',
                  }}
                >
                  Selected Node
                </div>
      ...
      <div
        ...
        style={{ 
          ...
          background: 'var(--bg-base)',
          boxShadow: '0 -4px 12px color-mix(in srgb, var(--bg-color), transparent 95%)'
        }}
      >
          ...
          {isVerifying && (
            <div className="flex items-center gap-1">
              <button
                ...
                style={{
                  background: inputMode === 'answer' ? 'var(--accent-primary)' : 'transparent',
                  color: inputMode === 'answer' ? 'var(--accent-foreground)' : 'var(--text-muted)',
                  border: '1px solid var(--border-subtle)'
                }}
              ...
              <button
                className="h-7 px-2.5 rounded-lg text-[11px] font-medium transition-all"
                style={{
                  background: inputMode === 'chat' ? 'var(--accent-muted)' : 'transparent',
                  color: inputMode === 'chat' ? 'var(--accent-primary)' : 'var(--text-muted)',
                  border: '1px solid var(--border-subtle)'
                }}
          ...
          {!isVerifying && (
            <>
              <button
                ...
                style={{
                  border: '1px solid var(--border-subtle)',
                  background: assistantMode === 'chat' ? 'var(--bg-elevated)' : 'transparent',
                  color: assistantMode === 'chat' ? 'var(--text-primary)' : 'var(--text-muted)'
                }}
              ...
              <button
                ...
                style={{
                  border: '1px solid var(--border-subtle)',
                  background: assistantMode === 'edit-note' ? 'var(--accent-muted)' : 'transparent',
                  color: assistantMode === 'edit-note' ? 'var(--accent-primary)' : 'var(--text-muted)'
                }}
