...
import { Minus, Square, X, BookOpen, Settings, MessageSquare, Keyboard } from 'lucide-react'
...
export function TitleBar() {
  const { activeView, setActiveView, setSettingsOpen, toggleStudentPanel, studentPanelOpen, activeNote } = useStore()
