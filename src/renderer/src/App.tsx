...
import { FirstTimeWelcome } from './components/tutorial/FirstTimeWelcome'
...
export default function App() {
  const { activeView, mode, settings, setSettings, sessions, setFormulaMode, tutorialCompleted, tutorialSkipped } = useStore()
  const api = useElectron()
  const [shortcutsOpen, setShortcutsOpen] = useState(false)
  const [showWelcome, setShowWelcome] = useState(false)
  useTheme()

  // Show welcome dialog on first load if tutorial not completed
  useEffect(() => {
  ...
  }, [tutorialCompleted, tutorialSkipped])
  ...
  return (
    <ErrorBoundary>
      ...
      <FirstTimeWelcome open={showWelcome} onClose={() => setShowWelcome(false)} />
